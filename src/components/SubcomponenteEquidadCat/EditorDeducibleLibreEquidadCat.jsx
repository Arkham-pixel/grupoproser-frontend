...
export function textoSugeridoDeducibleEquidadCat(cfg = {}) {
...
/**
 * Deducible EquidadCat: solo el texto y la fórmula (% / SMMLV).
 */
export default function EditorDeducibleLibreEquidadCat({
  cfg = {},
  onChange,
  disabled = false,
} = {}) {
