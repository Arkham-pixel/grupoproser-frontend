 ...
 */
export default function ModalSinActualizacionesAlfa({
  open,
  fileName,
  lastModifiedDisplay,
  lastCheckedDisplay,
    ...
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm">
      <DialogTitle sx={{ pb: 1 }}>
        <Typography variant="h6" fontWeight={700} component="div">
          Seguros Alfa — Sin actualizaciones
        </Typography>
      </DialogTitle>
      <DialogContent>
        <Typography variant="body1" sx={{ mb: 1.5 }}>
          No hay actualizaciones pendientes de Seguros Alfa.
        </Typography>
        ...
        <Stack spacing={0.5}>
          ...
          <Typography variant="caption" color="text.secondary">
            Actualizado por Alfa: {lastModifiedDisplay || '—'}
          </Typography>
          <Typography variant="caption" color="text.secondary">
