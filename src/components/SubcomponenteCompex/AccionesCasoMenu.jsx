...
import { complexTableBtnNeutral } from './complexFenixUi.js';

/**
 * Botón único que despliega acciones del caso en el reporte Complex.
 * El menú se renderiza en portal (fixed) para no quedar cortado por overflow de la tabla.
 */
  ...
  return (
    <div className="relative inline-block">
      <button
        ref={btnRef}
        type="button"
        className={`${complexTableBtnNeutral} min-w-[7.5rem] justify-between gap-2`}
        aria-haspopup="menu"
      ...
      >
        <span className="inline-flex items-center gap-1.5">
          <FaEllipsisV className="text-[10px] opacity-70" aria-hidden />{t("complex.ui.acciones_caso_menu.acciones")}</span>
