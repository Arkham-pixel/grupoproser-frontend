 ...
 * con los datos del liquidador Previsora.
 */
...
/**
 * Excel liquidador Previsora = plantilla oficial Evaluación Sísmica NSR-10 rellenada.
 */
export async function generarLiquidadorPrevisoraExcelBlob(liquidador) {
  ...
  return {
    ...
    filename: `Evaluacion_Sismica_NSR10_Previsora_${safe}.xlsx`,
  };
}
