...
export default function AccionesPrevisoraMenu({
  onGestionar,
  onArchivero,
  onAbrirCaso,
  onLiquidador,
    ...
    ? createPortal(
        ...
        >
          ...
          >
            ...
            {t('previsora.report.uniqueReport')}
            {tieneInforme ? ' ✓' : ''}
          </button>
          )}
