...
import { fetchAllCasosAllianz, getCasoAllianzById } from '../../services/allianzService.js';
...
export default function ArchiveroAllianzPage() {
  ...
  useEffect(() => {
    ...
    async function cargar() {
      ...
      setError('');
      try {
        const actual = await getCasoAllianzById(casoIdFromQuery);
  ...
  const subtitulo = useMemo(() => {
    ...
    return t('allianz.archive.pageSubtitle');
  }, [caso, t]);
      ...
      <div className={expressPageWrap}>
        ...
        {!casoId && !cargandoCaso && (
          <AllianzCasoPicker
            ...
            onSelect={elegirCaso}
            hint={t('allianz.archive.pickCase')}
          />
        )}
