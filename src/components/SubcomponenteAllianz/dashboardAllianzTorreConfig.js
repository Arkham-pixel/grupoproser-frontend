/**
 * Valores por defecto de la torre CAT Allianz (listado).
 * Misma metodología que Zurich; plazos y umbrales de reserva equivalentes.
 */
export const TORRE_CONFIG_ALLIANZ_DEFAULT = {
  version: 1,
  ans: {
    inspeccionDias: 15,
    liquidacionDias: 45,
...
export const TABS_TORRE_ALLIANZ = ['resumen', 'operacion', 'economico', 'detalle'];
