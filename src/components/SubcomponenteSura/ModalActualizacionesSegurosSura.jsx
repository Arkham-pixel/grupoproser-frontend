...
import { suraFieldLabel, formatSuraPreviewValue } from './suraActualizacionesModalPresentacion.js';
  ...
  return (
    <Box sx={{ mt: 1.5 }}>
      ...
      <Typography variant="subtitle2" fontWeight={600}>
        {entry.label || suraFieldLabel(entry.field)}
      </Typography>
      <Stack
...
/**
 * Modal ejecutivo de actualizaciones Seguros Sura (solo presentación).
 */
export default function ModalActualizacionesSegurosSura({
  open,
  viewModel,
  showAllChanges,
  confirmOpen,
      ...
      <Dialog open={open} onClose={onClose} fullWidth maxWidth="md" scroll="paper">
        <DialogTitle sx={{ pb: 1 }}>
          ...
          <Stack spacing={0.25} sx={{ mt: 1.25 }}>
            ...
            <Typography variant="caption" color="text.secondary">
              Actualizado por Sura: {vm.lastModifiedDisplay}
            </Typography>
            <Typography variant="caption" color="text.secondary">
