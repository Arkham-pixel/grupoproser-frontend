 ...
 * Preview local inmediata; subida al caso Sura en segundo plano.
 */
export default function FotosInspeccionSura({
  casoId,
  fotosInforme = [],
  ...
  const handleImageUpload = async (event) => {
    ...
    try {
      ...
      console.error('❌ Error procesando imágenes Sura:', error);
  ...
  const eliminarImagen = async (id) => {
    ...
    if (img?._id && casoId) {
      try {
        await eliminarArchivoSura(casoId, img._id);
