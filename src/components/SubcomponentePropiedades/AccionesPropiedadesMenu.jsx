...
export default function AccionesPropiedadesMenu({
  onGestionar,
  onInspeccion,
  onEliminar,
  ...
  const menu = abierto
    ? createPortal(
        <div
          ref={menuRef}
          role="menu"
          className="fixed z-[80] w-52 overflow-hidden rounded-xl border border-gray-200 bg-white py-1 shadow-lg dark:border-gray-700 dark:bg-[#1A1A1A]"
          style={{
