      ...
      new TableRow({
        children: [
          ...
          ...[
            ...
            ["4.", "PROCESOS", "11"],
            ["5.", "LINDEROS", "12"],
            ["", "MAPA DE UBICACIÓN", "13"],
            ["5.1.", "CARACTERÍSTICAS DE LA CONSTRUCCIÓN", "13"],
            ["5.2.", "MATERIALES", "14"],
            ["6.", "SUSTRACCIÓN - PROTECCIONES FÍSICAS", "15"],
            ["7.", "CARACTERÍSTICAS OPERATIVAS AMBIENTALES", "16"],
            ["8.", "PROTECCIÓN Y PREVENCIÓN CONTRA INCENDIOS", "17"],
            ["9.", "LUCRO CESANTE", "18"],
            ["9.", "LUCRO CESANTE", "18"],
            ["10.", "PROCESOS CRÍTICOS Y RIESGOS MEDIOAMBIENTALES", "19"],
            ["11.", "POR ROTURA DE MAQUINARIA", "20"],
            ["12.", "MAQUINARIA, EQUIPOS Y MANTENIMIENTO", "21"],
            ["13.", "SERVICIOS INDUSTRIALES", "22"],
            ["14.", "SEGURIDAD", "23"],
            ["15.", "SINIESTRALIDAD", "24"],
            ["16.", "ANÁLISIS Y CLASIFICACIÓN DE RIESGOS", "25"],
            ["", "ANÁLISIS DE RIESGOS", "25"],
            ["", "CLASIFICACIÓN DE RIESGOS", "26"],
            ["", "CALIFICACIÓN DEL RIESGO (R) E ÍNDICE DE VULNERABILIDAD", "27"],
            ["", "MATRIZ DE CALOR DE RIESGOS", "28"],
            ["17.", "RECOMENDACIONES", "29"],
            ["18.", "REGISTRO FOTOGRÁFICO", "30"]
...
docContent.push(
  ...
  docContent.push(
    new Paragraph({ text: "", spacing: { after: 300 } }),
    seccion("5.1. CARACTERÍSTICAS DE LA CONSTRUCCIÓN"),
      ...
      rows: [
        ...
        new TableRow({
          children: [
            ...
            celdaTexto(regularidadPlanta || ""),
            encabezadoTabla("Daños previos"),
            celdaTexto(danosPrevios || ""),
          ],
        }),
        new TableRow({
          children: [
        ...
        new TableRow({
          children: [
            ...
            celdaTexto(regularAltura || ""),
          ],
        }),
        new TableRow({
          children: [
            encabezadoTabla("Daños reparados"),
            celdaTexto(danosReparados || ""),
            new TableCell({ children: [new Paragraph("")], width: { size: 25, type: WidthType.PERCENTAGE } }),
            new TableCell({ children: [new Paragraph("")], width: { size: 25, type: WidthType.PERCENTAGE } }),
          ],
        }),
  ...
  // Agregar sección de Materiales solo si hay datos
  ...
  if (tieneDatosInsumos || tieneDatosMateriasPrimas || tieneDatosMercancias) {
    docContent.push(
      new Paragraph({ text: "", spacing: { after: 300 } }),
      new Paragraph({ text: "5.2. MATERIALES", bold: true, spacing: { after: 200 } })
    );
    ...
    // Tabla de Producto terminado y/o Mercancías
  ...
  docContent.push(
    new Paragraph({ text: "", spacing: { after: 200 } }),
    new Paragraph({ text: "Información adicional", bold: true, spacing: { after: 100 } }),
    new Table({
      width: { size: 100, type: WidthType.PERCENTAGE },
      rows: [
        new TableRow({
          children: [
            encabezadoTabla("Extintor"),
            celdaTexto(extintor || ""),
          ],
        }),
        new TableRow({
          children: [
            encabezadoTabla("Red contraincendio (RCI)"),
            celdaTexto(rci || ""),
          ],
        }),
        new TableRow({
          children: [
            encabezadoTabla("Sistema de rociadores"),
            celdaTexto(rociadores || ""),
          ],
        }),
        new TableRow({
          children: [
            encabezadoTabla("Detección de incendios"),
            celdaTexto(deteccion || ""),
          ],
        }),
        new TableRow({
          children: [
            encabezadoTabla("Alarmas de incendio"),
            celdaTexto(alarmas || ""),
          ],
        }),
        new TableRow({
          children: [
            encabezadoTabla("Brigadas de emergencia"),
            celdaTexto(brigadas || ""),
          ],
        }),
        new TableRow({
          children: [
            encabezadoTabla("Bomberos"),
            celdaTexto(bomberos || ""),
          ],
        }),
      ],
  ...
  docContent.push(
    ...
    new Paragraph({ text: "Protecciones Físicas", bold: true, spacing: { after: 100 } }),
    new Table({
      width: { size: 100, type: WidthType.PERCENTAGE },
      rows: [
        new TableRow({
...
const cargarDatosFormulario = async (formularioId) => {
  try {
    ...
    if (data.success && data.formulario) {
      ...
      setSistemaFiltracionGases(formulario.datos?.sistemaFiltracionGases || '');
      setNivelesRuido(formulario.datos?.nivelesRuido || '');
      setProgramaGestionAmbiental(formulario.datos?.programaGestionAmbiental || '');
      // Protección contra incendios detallado
      ...
      setUbicacionPredio(formulario.datos?.ubicacionPredio || '');
      setVulnerabilidadContenidos(formulario.datos?.vulnerabilidadContenidos || '');
      setAccesoInstalaciones(formulario.datos?.accesoInstalaciones || '');
      setCirculacionPersonasExternas(formulario.datos?.circulacionPersonasExternas || '');
      setProteccionesPasivas(formulario.datos?.proteccionesPasivas || '');
      setTieneAlarma(formulario.datos?.tieneAlarma || '');
      setAlarmaMonitoreadaSustraccion(formulario.datos?.alarmaMonitoreadaSustraccion || '');
      setEmpresaMonitorea(formulario.datos?.empresaMonitorea || '');
      setTipoComunicacionAlarma(formulario.datos?.tipoComunicacionAlarma || '');
      setCoberturaAlarma(formulario.datos?.coberturaAlarma || '');
      setSensoresAlarma(formulario.datos?.sensoresAlarma || '');
      setCuentaConCCTV(formulario.datos?.cuentaConCCTV || '');
      setNumeroCamaras(formulario.datos?.numeroCamaras || '');
      setControladoPor(formulario.datos?.controladoPor || '');
      setTipoMonitoreoCCTV(formulario.datos?.tipoMonitoreoCCTV || '');
      setFrecuenciaGrabacion(formulario.datos?.frecuenciaGrabacion || '');
      setTiempoRespaldo(formulario.datos?.tiempoRespaldo || '');
      setDispositivoGrabacion(formulario.datos?.dispositivoGrabacion || '');
      setUbicacionGrabador(formulario.datos?.ubicacionGrabador || '');
      setVisualizacionInternet(formulario.datos?.visualizacionInternet || '');
      setCuentaConVigilancia(formulario.datos?.cuentaConVigilancia || '');
      setContratadaCon(formulario.datos?.contratadaCon || '');
      setNumeroVigilantes(formulario.datos?.numeroVigilantes || '');
      setJornadaVigilancia(formulario.datos?.jornadaVigilancia || '');
      setTienenArmas(formulario.datos?.tienenArmas || '');
      setTienenRadio(formulario.datos?.tienenRadio || '');
      // Campos "Otro" de Sustracción
      setUbicacionPredioOtro(formulario.datos?.ubicacionPredioOtro || '');
      setVulnerabilidadContenidosOtro(formulario.datos?.vulnerabilidadContenidosOtro || '');
      setAccesoInstalacionesOtro(formulario.datos?.accesoInstalacionesOtro || '');
      setCirculacionPersonasExternasOtro(formulario.datos?.circulacionPersonasExternasOtro || '');
      setProteccionesPasivasOtro(formulario.datos?.proteccionesPasivasOtro || '');
      setTipoComunicacionAlarmaOtro(formulario.datos?.tipoComunicacionAlarmaOtro || '');
      setSensoresAlarmaOtro(formulario.datos?.sensoresAlarmaOtro || '');
      setControladoPorOtro(formulario.datos?.controladoPorOtro || '');
      setTipoMonitoreoCCTVOtro(formulario.datos?.tipoMonitoreoCCTVOtro || '');
      setFrecuenciaGrabacionOtro(formulario.datos?.frecuenciaGrabacionOtro || '');
      setDispositivoGrabacionOtro(formulario.datos?.dispositivoGrabacionOtro || '');
      setUbicacionGrabadorOtro(formulario.datos?.ubicacionGrabadorOtro || '');
      setJornadaVigilanciaOtro(formulario.datos?.jornadaVigilanciaOtro || '');
      // Lucro Cesante
      setAreaRequeridaLucroCesante(formulario.datos?.areaRequeridaLucroCesante || '');
      setComplejidadActividadLucroCesante(formulario.datos?.complejidadActividadLucroCesante || '');
      setPlanContinuidadNegocio(formulario.datos?.planContinuidadNegocio || '');
      setValorNominaMensual(formulario.datos?.valorNominaMensual || '');
      setValorFacturacionAnoAnterior(formulario.datos?.valorFacturacionAnoAnterior || '');
      setValorProyectadoFacturacion(formulario.datos?.valorProyectadoFacturacion || '');
      setComentariosLucroCesante(formulario.datos?.comentariosLucroCesante || '');
      // Campos "Otro" para Lucro Cesante
      setAreaRequeridaLucroCesanteOtro(formulario.datos?.areaRequeridaLucroCesanteOtro || '');
      setComplejidadActividadLucroCesanteOtro(formulario.datos?.complejidadActividadLucroCesanteOtro || '');
      // Procesos Críticos y Riesgos Medioambientales
      ...
      setCapacidadInstaladaPlanta(formulario.datos?.capacidadInstaladaPlanta || '');
      setIndicePromedioCapacidad(formulario.datos?.indicePromedioCapacidad || '');
      setNumeroLineasProduccion(formulario.datos?.numeroLineasProduccion || '');
      setMaquinariaCritica(formulario.datos?.maquinariaCritica || '');
      setIncidenciaProduccion(formulario.datos?.incidenciaProduccion || '');
      setOrigenMaquinariaCritica(formulario.datos?.origenMaquinariaCritica || '');
      setRepresentacionNacionalMaquinaria(formulario.datos?.representacionNacionalMaquinaria || '');
      setMaquinariaStandBy(formulario.datos?.maquinariaStandBy || '');
      setEmpresasSateliteProduccion(formulario.datos?.empresasSateliteProduccion || '');
      setConveniosOtrasEmpresas(formulario.datos?.conveniosOtrasEmpresas || '');
      ...
      >
        ...
        <div className="text-left sm:text-right w-full sm:w-auto">
          ...
          <input
            type="date"
            value={fecha}
            onChange={(e) => startTransition(() => setFecha(e.target.value))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
        ...
        <div>
          ...
          <input
            ...
            onChange={e => startTransition(() => setFormData({ ...formData, direccion: e.target.value }))}
            className="w-full rounded px-2 sm:px-3 py-2 text-sm"
            style={{
              backgroundColor: inputBg,
              color: textPrimary,
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
      ...
      <input
        ...
        onChange={e => startTransition(() => setFormData({ ...formData, departamento_siniestro: e.target.value }))}
        className="w-full rounded px-3 py-2"
        style={{
          backgroundColor: inputBg,
          color: textPrimary,
...
<textarea
  ...
  onChange={(e) => startTransition(() => setDescripcionEmpresa(e.target.value))}
  className="w-full rounded px-3 py-2"
  style={{
    backgroundColor: inputBg,
    color: textPrimary,
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  <div>
    ...
    >
      Antigüedad
        ...
        value={antiguedad}
        onChange={(e) => startTransition(() => setAntiguedad(e.target.value))}
        className="w-full rounded px-3 py-2"
        style={{
          backgroundColor: inputBg,
          color: textPrimary,
  ...
  <div>
    ...
    >
      Área Lote
        ...
        value={areaLote}
        onChange={(e) => startTransition(() => setAreaLote(e.target.value))}
        className="w-full rounded px-3 py-2"
        style={{
          backgroundColor: inputBg,
          color: textPrimary,
  ...
  <div>
    ...
    >
      Área Construida
        ...
        onChange={(e) => startTransition(() => setAreaConstruida(e.target.value))}
        className="w-full rounded px-3 py-2"
        style={{
          backgroundColor: inputBg,
          color: textPrimary,
  ...
  <div>
    ...
    >
      Nº de Edificios
        ...
        onChange={(e) => startTransition(() => setNumeroEdificios(e.target.value))}
        className="w-full rounded px-3 py-2"
        style={{
          backgroundColor: inputBg,
          color: textPrimary,
  ...
  <div>
    ...
    >
      Nº de Pisos
        ...
        placeholder="Ej: 3"
        value={numeroPisos}
        onChange={(e) => startTransition(() => setNumeroPisos(e.target.value))}
        className="w-full rounded px-3 py-2"
        style={{
          backgroundColor: inputBg,
          color: textPrimary,
  ...
  <div>
    ...
    >
      Sótanos
        ...
        placeholder="Ej: No"
        value={sotanos}
        onChange={(e) => startTransition(() => setSotanos(e.target.value))}
        className="w-full rounded px-3 py-2"
        style={{
          backgroundColor: inputBg,
          color: textPrimary,
  ...
  <div>
    ...
    >
      Propio o Arrendado
        ...
        value={tenencia}
        onChange={(e) => startTransition(() => setTenencia(e.target.value))}
        className="w-full rounded px-3 py-2"
        style={{
          backgroundColor: inputBg,
          color: textPrimary,
  ...
  <div className="md:col-span-2">
    ...
    <textarea
      ...
      onChange={(e) => startTransition(() => setDescripcionInfraestructura(e.target.value))}
      className="w-full rounded px-3 py-2"
      style={{
        backgroundColor: inputBg,
        color: textPrimary,
...
>
  ...
  <textarea
    ...
    value={procesos}
    onChange={(e) => startTransition(() => setProcesos(e.target.value))}
    rows={5}
    className="w-full rounded px-3 py-2"
    style={{
      backgroundColor: inputBg,
...
<div className="grid grid-cols-2 gap-4 text-sm mb-6">
    ...
    <input
      ...
      id="norte"
      value={linderoNorte}
      onChange={(e) => startTransition(() => setLinderoNorte(e.target.value))}
    ...
    <input
      ...
      id="sur"
      value={linderoSur}
      onChange={(e) => startTransition(() => setLinderoSur(e.target.value))}
      placeholder="Ej. Vía pública"
      className="px-2 py-1 rounded w-full"
      style={{
        backgroundColor: inputBg,
    ...
    <input
      ...
      onChange={(e) => startTransition(() => setLinderoOriente(e.target.value))}
    ...
    <input
      ...
      onChange={(e) => startTransition(() => setLinderoOccidente(e.target.value))}
...
{/* SECCIÓN CARACTERÍSTICAS DE LA CONSTRUCCIÓN */}
<div 
  className="mt-8 p-6 rounded shadow-sm"
  style={{
    backgroundColor: cardBg,
...
<div className="mb-6">
  ...
  <textarea
    ...
    onChange={(e) => startTransition(() => setCaracteristicasConstruccion(e.target.value))}
    className="w-full rounded px-3 py-2"
    style={{
      backgroundColor: inputBg,
      color: textPrimary,
      ...
      <tbody>
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <select
              value={tipoEdificio}
              onChange={(e) => startTransition(() => setTipoEdificio(e.target.value))}
            ...
            {tipoEdificio === "Otro" && (
              <input
                ...
                onChange={(e) => startTransition(() => setTipoEdificioOtro(e.target.value))}
        ...
        <tr>
          ...
          >
            <input
              ...
              onChange={(e) => startTransition(() => setAreaLoteConstruccion(e.target.value))}
          ...
          >
            <input
              ...
              onChange={(e) => startTransition(() => setAreaConstruidaConstruccion(e.target.value))}
        ...
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setNumeroPisosConstruccion(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
      ...
      <tbody>
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <select
              value={cimentacion}
              onChange={(e) => startTransition(() => setCimentacion(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
            ...
            {cimentacion === "Otro" && (
              <input
                ...
                onChange={(e) => startTransition(() => setCimentacionOtro(e.target.value))}
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setMaterialesEstructura(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
            ...
            {materialesEstructura === "Otro" && (
              <input
                ...
                onChange={(e) => startTransition(() => setMaterialesEstructuraOtro(e.target.value))}
        ...
        <tr>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setRegularidadPlanta(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
          ...
          >
            <select
              value={danosPrevios}
              onChange={(e) => startTransition(() => setDanosPrevios(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
        ...
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setReforzamientosEstructurales(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setSistemaEstructural(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
            ...
            {sistemaEstructural === "Otro" && (
              <input
                ...
                onChange={(e) => startTransition(() => setSistemaEstructuralOtro(e.target.value))}
        ...
        <tr>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setEstructuraCubierta(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
            ...
            {estructuraCubierta === "Otro" && (
              <input
                ...
                onChange={(e) => startTransition(() => setEstructuraCubiertaOtro(e.target.value))}
          ...
          >
            <select
              value={regularAltura}
              onChange={(e) => startTransition(() => setRegularAltura(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
        ...
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setDanosReparados(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
...
{/* SECCIÓN MATERIALES: INSUMOS, MATERIAS PRIMAS Y PRODUCTO TERMINADO */}
<div 
  className="mt-8 p-6 rounded shadow-sm"
  style={{
    backgroundColor: cardBg,
      ...
      <tbody>
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <select
              value={tipoInsumo}
              onChange={(e) => startTransition(() => setTipoInsumo(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
            ...
            {tipoInsumo === "Otro" && (
              <input
                ...
                onChange={(e) => startTransition(() => setTipoInsumoOtro(e.target.value))}
        ...
        <tr>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setNivelRiesgoInsumo(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
        ...
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <input
              ...
              onChange={(e) => startTransition(() => setDescripcionContenidosInsumo(e.target.value))}
              placeholder="Ej: Sal"
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
        ...
        <tr>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setContenedoresInsumo(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
            ...
            {contenedoresInsumo === "Otro" && (
              <input
                ...
                onChange={(e) => startTransition(() => setContenedoresInsumoOtro(e.target.value))}
        ...
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setTipoAlmacenamientoInsumo(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
            ...
            {tipoAlmacenamientoInsumo === "Otro" && (
              <input
                ...
                onChange={(e) => startTransition(() => setTipoAlmacenamientoInsumoOtro(e.target.value))}
        ...
        <tr>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setEstadoAlmacenamientoInsumo(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
        ...
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setTipoMateriasPrimas(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
            ...
            {tipoMateriasPrimas === "Otro" && (
              <input
                ...
                onChange={(e) => startTransition(() => setTipoMateriasPrimasOtro(e.target.value))}
        ...
        <tr>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setNivelRiesgoMateriasPrimas(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
        ...
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <input
              ...
              onChange={(e) => startTransition(() => setDescripcionContenidosMateriasPrimas(e.target.value))}
        ...
        <tr>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setContenedoresMateriasPrimas(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
            ...
            {contenedoresMateriasPrimas === "Otro" && (
              <input
                ...
                onChange={(e) => startTransition(() => setContenedoresMateriasPrimasOtro(e.target.value))}
                placeholder="Especifique el tipo de contenedor..."
                className="w-full px-2 py-1 rounded mt-2"
                style={{
                  backgroundColor: inputBg,
        ...
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setTipoAlmacenamientoMateriasPrimas(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
            ...
            {tipoAlmacenamientoMateriasPrimas === "Otro" && (
              <input
                ...
                onChange={(e) => startTransition(() => setTipoAlmacenamientoMateriasPrimasOtro(e.target.value))}
                placeholder="Especifique el tipo de almacenamiento..."
                className="w-full px-2 py-1 rounded mt-2"
                style={{
                  backgroundColor: inputBg,
        ...
        <tr>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setEstadoAlmacenamientoMateriasPrimas(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
        ...
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setTipoMercancias(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
            ...
            {tipoMercancias === "Otro" && (
              <input
                ...
                onChange={(e) => startTransition(() => setTipoMercanciasOtro(e.target.value))}
        ...
        <tr>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setNivelRiesgoMercancias(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
        ...
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <input
              ...
              onChange={(e) => startTransition(() => setDescripcionContenidosMercancias(e.target.value))}
        ...
        <tr>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setContenedoresMercancias(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
            ...
            {contenedoresMercancias === "Otro" && (
              <input
                ...
                onChange={(e) => startTransition(() => setContenedoresMercanciasOtro(e.target.value))}
                placeholder="Especifique el tipo de contenedor..."
                className="w-full px-2 py-1 rounded mt-2"
                style={{
                  backgroundColor: inputBg,
        ...
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setTipoAlmacenamientoMercancias(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
            ...
            {tipoAlmacenamientoMercancias === "Otro" && (
              <input
                ...
                onChange={(e) => startTransition(() => setTipoAlmacenamientoMercanciasOtro(e.target.value))}
                placeholder="Especifique el tipo de almacenamiento..."
                className="w-full px-2 py-1 rounded mt-2"
                style={{
                  backgroundColor: inputBg,
        ...
        <tr>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setEstadoAlmacenamientoMercancias(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
        ...
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setDetectoresHumo(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
        ...
        <tr>
          ...
          >
            <input
              ...
              onChange={(e) => startTransition(() => setCoberturaDeteccion(e.target.value))}
        ...
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <input
              ...
              onChange={(e) => startTransition(() => setInstalacionDeteccion(e.target.value))}
        ...
        <tr>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setMonitoreadoDeteccion(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
        ...
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <input
              ...
              onChange={(e) => startTransition(() => setCantidadExtintores(e.target.value))}
              placeholder="Ej: 8"
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
        ...
        <tr>
          ...
          >
            <input
              ...
              onChange={(e) => startTransition(() => setTipoExtintores(e.target.value))}
        ...
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setSuficientesExtintores(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
        ...
        <tr>
          ...
          >
            <input
              ...
              onChange={(e) => startTransition(() => setInstalacionExtintores(e.target.value))}
        ...
        <tr style={{ backgroundColor: theme === 'dark' ? '#1F1F1F' : '#E5E7EB' }}>
          ...
          >
            <input
              ...
              onChange={(e) => startTransition(() => setSenalizacionExtintores(e.target.value))}
              placeholder="Ej: Adecuado"
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
        ...
        <tr>
          ...
          >
            <select
              ...
              onChange={(e) => startTransition(() => setCargaVigenteExtintores(e.target.value))}
              className="w-full px-2 py-1 rounded"
              style={{
                backgroundColor: inputBg,
                color: textPrimary,
...
{/* Campos adicionales de protección contra incendios */}
<div className="mb-6">
  <h3 
    className="text-lg font-semibold mb-3"
    style={{ color: textPrimary }}
...
<FormularioAreas onChange={useCallback((areas) => {
...
>
  ...
  >
    ...
    <Suspense fallback={<div style={{ color: textPrimary }}>Cargando asistente...</div>}>
      ...
      }), [formData, recomendaciones, bancoRecomendaciones, categoriaSeleccionada, nombreCliente, analisisRiesgos, tablaRiesgos, energiaProveedor, energiaTension, transformadores, plantasElectricas, extintor, rci, rociadores, deteccion, alarmas, brigadas, bomberos, alarmaMonitoreada, cctv, tipoVigilancia, horariosVigilancia, accesos, cerramientoPredio])}
