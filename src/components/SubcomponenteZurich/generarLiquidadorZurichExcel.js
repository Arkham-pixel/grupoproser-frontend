 ...
 * con los datos del liquidador Zurich.
 */
...
/**
 * Excel liquidador Zurich = plantilla oficial Evaluación Sísmica NSR-10 rellenada.
 */
export async function generarLiquidadorZurichExcelBlob(liquidador) {
  ...
  return {
    ...
    filename: `Evaluacion_Sismica_NSR10_Zurich_${safe}.xlsx`,
  };
}
