  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
        ...
        >
          <FaUpload />
          {subiendo ? t('zurich.archive.uploading') : t('zurich.archive.upload')}
        </button>
      </div>
          ...
          <thead className="bg-gray-50 dark:bg-gray-900/50">
            <tr>
              <th className="px-3 py-2 text-left font-body text-xs font-semibold uppercase text-gray-500">
                {t('zurich.archive.file')}
              </th>
              <th className="px-3 py-2 text-left font-body text-xs font-semibold uppercase text-gray-500">
                {t('zurich.archive.label')}
              </th>
              <th className="px-3 py-2 text-left font-body text-xs font-semibold uppercase text-gray-500">
                {t('zurich.archive.size')}
              </th>
              <th className="px-3 py-2 text-left font-body text-xs font-semibold uppercase text-gray-500">
                {t('zurich.archive.date')}
              </th>
                ...
                return (
                  <tr key={arch._id}>
                    ...
                    <td className="px-3 py-2 font-body text-sm text-gray-600 dark:text-gray-300">
                      {t(`zurich.archive.labels.${arch.etiqueta || 'GENERAL'}`, {
