  ...
  const contenidoFormulario = (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <section className={expressFormSection}>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Campo label={t('zurich.fields.modalidadAtencion')}>
            {selectSimple('modalidadAtencion', MODALIDADES_ZURICH)}
          </Campo>
      ...
      <section className={expressFormSection}>
        ...
        <p className="mb-3 font-body text-sm text-gray-600 dark:text-gray-400">
          {t('zurich.sections.actionDatesHint')}
        </p>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Campo label={t('zurich.fields.fechaRecepcionDocumento')}>
            <InputFenix
              type="date"
          ...
          <Campo label={t('zurich.fields.fechaEnProcesoFacturacion')}>
            <InputFenix
              type="date"
          ...
          <Campo label={t('zurich.fields.fechaFacturado')}>
            <InputFenix
              type="date"
