/**
 * Helpers de geocodificación BBVA CAT (cliente).
 * Debe alinearse con bbvaCatBloquesCercaniaService del backend.
 */
 ...
 */
export function geocodeConGooglePrecisoBbvaCat(address, caso = null) {
  const runOnce = (query) =>
    new Promise((resolve) => {
