...
/**
 * Menú de acciones estilo Complex (portal) para el reporte Equidad FDM.
 */
export default function AccionesFdmMenu({
  onGestionar,
  onArchivero,
  onLiquidador,
  onEliminar,
  ...
  const menu = abierto
    ? createPortal(
        ...
        >
          ...
          >
            <FaArchive className="text-fenix-primario" aria-hidden />
  ...
  return (
    <div className="relative inline-block">
      <button
        ...
        title={t('equidadFdm.menu.caseActions')}
      >
