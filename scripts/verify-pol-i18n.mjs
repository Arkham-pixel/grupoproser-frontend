...
const a = Object.keys(es).filter((k) => k.startsWith('pol.'));
const b = Object.keys(en).filter((k) => k.startsWith('pol.'));
console.log('pol es/en', a.length, b.length);
...
const files = walk('src/components/ReportePol');
const used = new Set();
